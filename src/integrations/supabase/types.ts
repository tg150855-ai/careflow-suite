  ...
  public: {
    Tables: {
      ...
      analytics_warehouse: {
        ...
        Relationships: [
          {
            foreignKeyName: "analytics_warehouse_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      api_usage_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "api_usage_logs_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
      ...
      compliance_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "compliance_metrics_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      franchises: {
        ...
        Relationships: [
          {
            foreignKeyName: "franchises_organization_id_fkey"
      ...
      revenue_streams: {
        ...
        Relationships: [
          {
            foreignKeyName: "revenue_streams_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
